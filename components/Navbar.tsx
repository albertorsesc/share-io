    ...
    <div className='w-full flex justify-between items-center border-b-2 border-gray-200 py-2 px-4'>
      ...
      <div className='relative hidden md:block'>
        <form
          ...
          className='flex justify-between absolute md:static top-10 -left-20 bg-white'>
          <input
            onChange={(e) => setSearchValue(e.target.value)}
            value={searchValue}
            type="text"
            placeholder='Search accounts and videos...'
            className='bg-primary p-3 md:text-md font-medium border-2 border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300 w-[300px] md:w-[420px] lg:w-[550px] rounded-full md:top-0'
          />
